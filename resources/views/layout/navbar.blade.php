        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav justify-content-end mt-4">
            <li class="nav-item pe-3 d-flex align-items-center">
              <a href="{{ route('profile') }}" class="nav-link text-white p-0" title="Profil">
                <i class="fa fa-user fs-4 cursor-pointer"></i>
              </a>
            </li>
            <li class="nav-item dropdown pe-2 d-flex align-items-center">
              <a href="{{route('actionlogout')}}" class="nav-link text-white p-0" title="Keluar">
                <i class="fa fa-sign-out fs-4 cursor-pointer"></i>
              </a>
            </li>
          </ul>
        </div>
